    ...
    const int processID=0)
{
  ...
  // const std::string input_file = "/sphenix/user/ryotaro/DirectPhotonAnalysis/Pi0Reconstruction/output/100kevents_5GeV_pi0_eta0_SPLIT_CLUSTERS_ShowerShape.root";
  const std::string input_file = "/sphenix/user/ryotaro/DirectPhotonAnalysis/Pi0Reconstruction/output/100kevents_10GeV_pi0_eta0_SPLIT_CLUSTERS_ShowerShape.root";
  // const std::string output_file = Form("/sphenix/user/ryotaro/DirectPhotonAnalysis/Pi0Reconstruction/output/3GeV_pi0_eta0_phi0_over300MeV_rehist_%s_SPLIT.root", pid_str.c_str());  
  const std::string output_file = "/sphenix/user/ryotaro/DirectPhotonAnalysis/Pi0Reconstruction/output/10GeV_pi0_eta0_over500MeV_rehist_SPLIT.root";  
  ...
  TH1D *h_ncluster = new TH1D("h_ncluster", "CEMC clusters per event;N_{cluster};Events", 10, 0.0, 10.0);
