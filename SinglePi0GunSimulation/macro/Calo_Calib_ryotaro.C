#ifndef CALO_CALIB_ryotaro_H
#define CALO_CALIB_ryotaro_H
...
void Process_Calo_Calib_ryotaro()
{
  ...
  statusEMC->set_inputNode("TOWERINFO_RAW_CEMC"); // edited by ryotaro
  // MC Towers Status
  if (isSim)
  {
  ...
  statusHCalIn->set_inputNode("TOWERINFO_RAW_HCALIN"); // edited by ryotaro
  se->registerSubsystem(statusHCalIn);

  CaloTowerStatus *statusHCALOUT = new CaloTowerStatus("HCALOUTSTATUS");
  statusHCALOUT->set_detector_type(CaloTowerDefs::HCALOUT);
  statusHCALOUT->set_inputNode("TOWERINFO_RAW_HCALOUT"); // edited by ryotaro
  ...
  calibEMC->set_inputNodePrefix("TOWERINFO_RAW_"); // edited by ryotaro
  calibEMC->set_outputNodePrefix("TOWERINFO_CALIBryotaro_"); // edited by ryotaro
  se->registerSubsystem(calibEMC);

  std::cout << "Calibrating OHcal" << std::endl;
  CaloTowerCalib *calibOHCal = new CaloTowerCalib("HCALOUT");
  calibOHCal->set_detector_type(CaloTowerDefs::HCALOUT);
  calibOHCal->set_inputNodePrefix("TOWERINFO_RAW_"); // edited by ryotaro
  calibOHCal->set_outputNodePrefix("TOWERINFO_CALIBryotaro_"); // edited by ryotaro
  se->registerSubsystem(calibOHCal);

  std::cout << "Calibrating IHcal" << std::endl;
  CaloTowerCalib *calibIHCal = new CaloTowerCalib("HCALIN");
  calibIHCal->set_detector_type(CaloTowerDefs::HCALIN);
  calibIHCal->set_inputNodePrefix("TOWERINFO_RAW_"); // edited by ryotaro
  calibIHCal->set_outputNodePrefix("TOWERINFO_CALIBryotaro_"); // edited by ryotaro
